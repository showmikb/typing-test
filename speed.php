...
<div class="form-group">
 ...
 <textarea id="textariffic" style="width:500px;"></textarea>
   ...
   <p> <span class="label" style="color:black" id="timerlabel">Timer : </span>
    ...
    <p> <span class="label" style="color:black">Total Words Per Minute : </span>
 		<span id="TPM">0</span>
    </p>
    <p> <span class="label" style="color:black">Correct Words Per Minute : </span>
 		<span id="WPM">0</span>
    </p>
...
function timer()
    {
          ...
          if (count <= 0){
              document.getElementById("timer").innerHTML="!! TIME UP !!";
					...
					iWords  = $('textarea').val().split(" ");				
					tpm=Math.round($('textarea').val().split(" ").length);
